...
[![x-cmd/install — tv Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/tv.svg?lang=zh)](https://x-cmd.com/install/tv)
...
合计: **6,986** 行代码（覆盖前 5 种语言、共 **32** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Rust | 4,251 | 695 | 442 | 10 |
| Python | 2,373 | 227 | 510 | 11 |
| Toml | 207 | 2 | 18 | 5 |
| Sh | 113 | 16 | 22 | 3 |
| Bash | 18 | 9 | 6 | 3 |
...
- **上游仓库**: <https://github.com/alexhallam/tv>
- **许可证**: MIT

## 发布

- **最新版本**: `1.8.93` (2025-08-11)
- **最近提交**: 2025-08-21
- **Release 含资产**: 6 个

## 流行度

- **Star**: 2,165 · **Fork**: 40 · **开放 issue**: 79 · **贡献者**: 24

## 累计统计

- **发布数**: 26 · **已合并 PR**: 102 · **开放 PR**: 9 · **已关闭 issue**: 60 · **开放 issue**: 19 · **提交数**: 346
...
| 360d | 2025-09-30 | 0 | 0 | 0 | 2 | 0 | 0 |
| last720d | 2024-10-05 | 4 | 11 | 9 | 2 | 6 | 89 |
...
tv 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `tv` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/tv.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260925.yml` · 2026-09-25T05:13:07Z._
